...
pub type int_64 = ::std::os::raw::c_longlong;
...
pub struct st_MInputStream {
    ...
    >,
    pub Mftell:
        ::std::option::Option<unsafe extern "C" fn(arg1: *mut st_MInputStream) -> int_64>,
...
pub struct st_MOutputStream {
    ...
    >,
    pub Mftell: ::std::option::Option<
        unsafe extern "C" fn(arg1: *mut st_MOutputStream) -> int_64,
    >,
    pub MferrorText: ::std::option::Option<
